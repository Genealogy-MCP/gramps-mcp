"""
Unit tests for identifier normalization and execute dispatch logic.

Tests normalize_identifier() which maps the LLM-invented 'identifier' param
...
from src.gramps_mcp.tools._identifier import normalize_identifier
...
class TestNormalizeIdentifier:
    ...
    def test_identifier_classified_as_gramps_id(self) -> None:
        ...
        result = normalize_identifier(params, SimpleGetParams)
    ...
    def test_identifier_maps_to_handle_when_schema_has_no_gramps_id(self) -> None:
        ...
        params = {"type": "person", "identifier": "I0028"}
        result = normalize_identifier(params, DeleteParams)
    ...
    def test_identifier_for_descendants_maps_to_gramps_id(self) -> None:
        ...
        result = normalize_identifier(params, DescendantsParams)
...
# ============================================================================
# execute_operation — schema validation (via library)
# ============================================================================
...
class TestExecuteSchemaValidation:
    ...
    async def test_invalid_params_raise_validation_error(self) -> None:
        ...
        from mcp_codemode import McpToolError, execute_operation
