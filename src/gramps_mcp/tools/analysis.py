...
This module contains analysis tools for genealogy research including
        ...
        if changes:
            ...
            for change in changes[:3]:  # Show first 3 changes
                ...
                if re.fullmatch(r"[a-f0-9]{8,}", gramps_id):
                    ...
                    display_id = gramps_id

                result += f"    - {obj_class}: {display_id}\n"
            if len(changes) > 3:
...
async def get_recent_changes_tool(client, arguments: Dict) -> List[TextContent]:
    ...
    try:
        ...
        raise_tool_error(e, "recent changes retrieval")
...
@with_client
async def get_tree_stats_tool(client, _arguments: Dict) -> List[TextContent]:
    """
    ...
    try:
        ...
        raise_tool_error(e, "tree information retrieval")
